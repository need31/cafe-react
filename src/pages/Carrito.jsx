...
function Carrito() {
    ...
    return (
        <Layout>
            ...
            <section className="bg-[#FFF8E7] min-h-screen py-16">

                <div className="max-w-6xl mx-auto px-6">

                    <h1 className="text-5xl font-bold text-[#4E342E] text-center mb-10">
                        Mi Carrito
                    </h1>
                        ...
                        <>
                            <div className="space-y-6">
                                ...
                                {carrito.map((producto) => (
                                    ...
                                    <div
                                        key={producto.id}
                                        className="bg-white rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center justify-between gap-6"
                                    >
